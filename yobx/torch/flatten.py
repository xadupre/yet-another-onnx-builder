...
def register_class_flattening(
    ...
    :func:`yobx.torch.flatten.unregister_class_flattening`.
...
def register_cache_flattening(
    ...
    :func:`yobx.torch.flatten.register_class_flattening`.
...
def unregister_class_flattening(cls: type, verbose: int = 0):
    ...
    assert cls not in pytree.SUPPORTED_NODES, (
        f"{cls} was not successfully unregistered "
...
def unregister_cache_flattening(undo: Dict[type, bool], verbose: int = 0):
    ...
    :func:`yobx.torch.flatten.register_cache_flattening`.
    """
    for cls in undo:
