...
class CustomTracer(torch.fx.Tracer):
    ...
    def replace_inplace_call_methods(cls, graph: torch.fx.Graph, verbose: int = 0) -> int:
        ...
        _method_to_aten = {
            ...
            "addcmul_": torch.ops.aten.addcmul.default,
    ...
    def replace_inplace_aten_functions(cls, graph: torch.fx.Graph, verbose: int = 0) -> int:
        ...
        _aten_inplace_to_non_inplace = {
            ...
            torch.ops.aten.addcmul_.default: torch.ops.aten.addcmul.default,
            ...
            torch.ops.aten.clamp_.default: torch.ops.aten.clamp.default,
            torch.ops.aten.clamp_.Tensor: torch.ops.aten.clamp.Tensor,
