...
def convert_read_variable_op(g: GraphBuilderExtendedProtocol, sts: Dict[str, Any], outputs: List[str], op) -> str:
...
def convert_const(g: GraphBuilderExtendedProtocol, sts: Dict[str, Any], outputs: List[str], op) -> str:
...
def convert_identity(g: GraphBuilderExtendedProtocol, sts: Dict[str, Any], outputs: List[str], op) -> str:
