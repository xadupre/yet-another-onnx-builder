...
def is_static_dimension(d: Any) -> bool:
    ...
    if isinstance(d, int):
        assert not isinstance(
            d, (torch.SymInt, torch.SymFloat, TracingInt)
...
def compatible_shapes(sh1: DYNAMIC_SHAPE, sh2: DYNAMIC_SHAPE) -> bool:
    ...
    .. runpython::
        ...
        from yobx.xshape._shape_helper import compatible_shapes
...
def compatible_dimensions(*dims: Sequence[Union[int, str]]) -> bool:
    ...
    .. runpython::
        ...
        from yobx.xshape._shape_helper import compatible_dimensions
