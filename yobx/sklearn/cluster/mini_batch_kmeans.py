...
@register_sklearn_converter(MiniBatchKMeans)
def sklearn_mini_batch_kmeans(
    ...
    (equivalent to :meth:`~sklearn.cluster.MiniBatchKMeans.predict`) and the
    Euclidean distances from each sample to every cluster centre
    (equivalent to :meth:`~sklearn.cluster.MiniBatchKMeans.transform`).
