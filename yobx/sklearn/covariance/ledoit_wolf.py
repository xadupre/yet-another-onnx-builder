...
@register_sklearn_converter(LedoitWolf)
def sklearn_ledoit_wolf(
    ...
    """
    Converts a :class:`sklearn.covariance.LedoitWolf` into ONNX.

    The converter maps to :meth:`~sklearn.covariance.LedoitWolf.mahalanobis`,
    ...
    :param estimator: a fitted ``LedoitWolf``
