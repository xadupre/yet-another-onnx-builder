...
@register_sklearn_converter((GraphicalLasso, GraphicalLassoCV))
def sklearn_graphical_lasso(
    ...
    """
    Converts a :class:`sklearn.covariance.GraphicalLasso` or
    :class:`sklearn.covariance.GraphicalLassoCV` into ONNX.

    Both estimators expose the same inference interface as
    :class:`~sklearn.covariance.EmpiricalCovariance`.  The converter maps to
    :meth:`~sklearn.covariance.EmpiricalCovariance.mahalanobis`, returning the
    **squared** Mahalanobis distance from the fitted distribution for each
    observation:
    ...
    :param estimator: a fitted ``GraphicalLasso`` or ``GraphicalLassoCV``
    :param X: input tensor name
    :param name: prefix for added node names
    :return: output tensor name
    """
    assert isinstance(
        estimator, (GraphicalLasso, GraphicalLassoCV)
