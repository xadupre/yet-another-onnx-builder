...
* a SQL string, a Python callable, or a `polars.LazyFrame <https://docs.polars.io/api/python/stable/reference/lazyframe/api/polars.LazyFrame.html>`_ → :func:`yobx.sql.to_onnx`
...
+-----------------------------+------------------------------------+----------------------------------+
| `polars.LazyFrame <https://docs.polars.io/api/python/stable/reference/lazyframe/api/polars.LazyFrame.html>`_ | :func:`yobx.sql.to_onnx`           | :ref:`l-design-sql-polars`       |
+-----------------------------+------------------------------------+----------------------------------+
