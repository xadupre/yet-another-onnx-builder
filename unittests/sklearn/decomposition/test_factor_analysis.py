"""
Unit tests for yobx.sklearn.decomposition.FactorAnalysis converter.
"""
...
class TestFactorAnalysis(ExtTestCase):
    def test_factor_analysis_basic(self):
        ...
        expected = fa.transform(X).astype(np.float32)
    ...
    def test_pipeline_factor_analysis_logistic_regression(self):
        from sklearn.decomposition import FactorAnalysis
