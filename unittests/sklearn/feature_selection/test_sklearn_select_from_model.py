"""
Unit tests for yobx.sklearn.feature_selection.SelectFromModel converter.
"""
...
class TestSelectFromModel(ExtTestCase):
    ...
    def test_select_from_model_float32(self):
    ...
    def test_select_from_model_float64(self):
        from sklearn.ensemble import RandomForestClassifier
        from sklearn.feature_selection import SelectFromModel
        from yobx.sklearn import to_onnx
    ...
    def test_select_from_model_linear_float32(self):
        from sklearn.feature_selection import SelectFromModel
    ...
    def test_select_from_model_pipeline_float32(self):
        from sklearn.ensemble import RandomForestClassifier
        from sklearn.feature_selection import SelectFromModel
        from sklearn.linear_model import LogisticRegression
    ...
    def test_select_from_model_pipeline_float64(self):
        from sklearn.ensemble import RandomForestClassifier
        from sklearn.feature_selection import SelectFromModel
        from sklearn.linear_model import LogisticRegression
        from sklearn.pipeline import Pipeline
