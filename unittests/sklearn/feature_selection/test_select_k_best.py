"""
Unit tests for yobx.sklearn.feature_selection.SelectKBest converter.
"""
...
class TestSelectKBest(ExtTestCase):
    ...
    def test_select_k_best_float32(self):
    ...
    def test_select_k_best_float64(self):
        from sklearn.feature_selection import SelectKBest, f_classif
        from yobx.sklearn import to_onnx
    ...
    def test_select_k_best_all_features(self):
        from sklearn.feature_selection import SelectKBest, f_classif
        from yobx.sklearn import to_onnx
    ...
    def test_select_k_best_k_one(self):
        from sklearn.feature_selection import SelectKBest, f_classif
        from yobx.sklearn import to_onnx
    ...
    def test_select_k_best_pipeline_float32(self):
        from sklearn.feature_selection import SelectKBest, f_classif
    ...
    def test_select_k_best_pipeline_float64(self):
        from sklearn.feature_selection import SelectKBest, f_classif
        from sklearn.linear_model import LogisticRegression
        from sklearn.pipeline import Pipeline
        from yobx.sklearn import to_onnx
