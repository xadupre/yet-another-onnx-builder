"""
Unit tests for yobx.sklearn.cluster.MiniBatchKMeans converter.
"""
...
class TestMiniBatchKMeans(ExtTestCase):
    # ------------------------------------------------------------------
    # Labels — float32 and float64
    # ------------------------------------------------------------------

    def test_mini_batch_kmeans_labels_float32(self):
        from sklearn.cluster import MiniBatchKMeans
        from yobx.sklearn import to_onnx

        rng = np.random.default_rng(0)
        X = rng.standard_normal((30, 4)).astype(np.float32)
        km = MiniBatchKMeans(n_clusters=3, random_state=0, n_init=10)
        km.fit(X)
    ...
    def test_mini_batch_kmeans_labels_float64(self):
        from sklearn.cluster import MiniBatchKMeans
        from yobx.sklearn import to_onnx
    ...
    def test_mini_batch_kmeans_distances_float32(self):
        from sklearn.cluster import MiniBatchKMeans
        from yobx.sklearn import to_onnx

        rng = np.random.default_rng(1)
        X = rng.standard_normal((20, 3)).astype(np.float32)
        km = MiniBatchKMeans(n_clusters=4, random_state=1, n_init=10)
        km.fit(X)
    ...
    def test_mini_batch_kmeans_distances_float64(self):
        from sklearn.cluster import MiniBatchKMeans
        from yobx.sklearn import to_onnx
        ...
        expected_distances = km.transform(X).astype(np.float64)
    ...
    def test_mini_batch_kmeans_pipeline(self):
        from sklearn.cluster import MiniBatchKMeans
    ...
    def test_mini_batch_kmeans_cdist_float32(self):
    ...
    def test_mini_batch_kmeans_cdist_float64(self):
