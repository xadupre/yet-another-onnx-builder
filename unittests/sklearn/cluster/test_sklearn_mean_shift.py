...
class TestMeanShift(ExtTestCase):
    ...
    def test_mean_shift_labels_float32(self):
    ...
    def test_mean_shift_labels_float64(self):
        from sklearn.cluster import MeanShift
        from yobx.sklearn import to_onnx
    ...
    def test_mean_shift_distances_float32(self):
        from sklearn.cluster import MeanShift
    ...
    def test_mean_shift_distances_float64(self):
        from sklearn.cluster import MeanShift
        from sklearn.metrics import pairwise_distances
        from yobx.sklearn import to_onnx
