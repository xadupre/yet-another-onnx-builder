...
# from yobx.xoptim.patterns_api import MatchResult, PatternOptimization
MatchResult = PatternOptimization = None
...
class TestReverseGraphBuilder(ExtTestCase):
    ...
    @unittest.skipIf(MatchResult is None, "not implemented yet")
