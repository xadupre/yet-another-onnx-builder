"""
Parity tests for the CountVectorizer converter, mirroring sklearn-onnx's
...
class TestSklearnCountVectorizerConverter(ExtTestCase):
    ...
    def test_model_count_vectorizer11_out_vocabulary(self):
    ...
    def test_model_count_vectorizer11_empty_string_case1(self):
